...
class Camera:
    ...
    def capture_food_image(self):
        ...
        x=-1 # bigger it is, more central it is, smaller, more off
        y=None
        neg_x= -1 #129  # bigger it is, more central it is, smaller, more off
        neg_y =129 #--> smaller, more desirable
